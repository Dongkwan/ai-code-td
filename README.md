...
> **"When detected duplicate code echoes the prompt: Reassessing code-smell
> measurements in LLM-generated benchmark classes"**
> Dong Kwan Kim, submitted to *Information and Software Technology*.

**Release 2026-08-10.** This release carries **data and figures only**. The
...
Sixty-two files, 2.6 MB unpacked (1.4 MB as a zip). All figures are the 300 dpi
...
```bibtex
@article{kim2026echo,
  title   = {When detected duplicate code echoes the prompt: Reassessing
             code-smell measurements in {LLM}-generated benchmark classes},
